  ...
  <form class="card auth-card" @submit.prevent="submitHandler">
    <div class="card-content">
      ...
      <div class="input-field">
        ...
        >{{'Message_EnterMail' | localize}}</small>
        <small class="helper-text invalid"
      ...
      <div class="input-field">
        ...
        >
          {{'Message_sizePasswordStartWarning' | localize}} {{ $v.password.$params.minLength.min }}
          {{'Message_sizePasswordFinishWarning' | localize}} {{ password.length }}
        </small>
      </div>
      <div class="input-field">
        <input
